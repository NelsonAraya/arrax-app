...
<div class="row mt-4"> <!-- Añade un margen superior al contenido -->
    <div class="col-md-8  offset-md-2"> <!-- Centra el contenido y ajusta el ancho -->
      <div class="card border-primary mb-3">
        ...
        <div class="card-body">
          <h5 class="card-title  text-primary">Ingreso de Banco </h5>
          <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('bancos.create') }}" class="btn btn-success">NUEVO BANCO <i class="bi bi-building-add"></i></a>
          ...
          <div class="table-responsive">
            <table id="tbl_banco" class="table table-striped" style="width:100%">
              <thead>
                <tr>
                    <th>ID</th>
                    <th>NOMBRE BANCO</th>
