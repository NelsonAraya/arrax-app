...
<div class="row mt-4"> <!-- Añade un margen superior al contenido -->
    <div class="col-md-8  offset-md-2"> <!-- Centra el contenido y ajusta el ancho -->
      <div class="card border-primary mb-3">
        <div class="card-header">MANTENEDOR DE ESTADOS DE USUARIOS</div>
        <div class="card-body">
          <h5 class="card-title  text-primary">Ingreso de Estados Usuario </h5>
          <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('est.create') }}" class="btn btn-success">NUEVO ESTADO <i class="bi bi-person-fill-lock"></i></a>
