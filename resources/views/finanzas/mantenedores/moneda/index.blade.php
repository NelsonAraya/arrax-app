...
<div class="row mt-4"> <!-- Añade un margen superior al contenido -->
    <div class="col-md-8  offset-md-2"> <!-- Centra el contenido y ajusta el ancho -->
      <div class="card border-primary mb-3">
        ...
        <div class="card-body">
          <h5 class="card-title  text-primary">Ingreso de Monedas </h5>
          <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('monedas.create') }}" class="btn btn-success">NUEVA MONEDA <i class="bi bi-currency-dollar"></i></i></a>
